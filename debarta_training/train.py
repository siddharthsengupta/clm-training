...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type in ["xlm", "roberta", "distilbert", "camembert", "bart", "longformer","debarta"]:
...
def main():
    ...
    parser.add_argument("--use_base_model", type=str, default="true", help="Use base model or pretrained model")
